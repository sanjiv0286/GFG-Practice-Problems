<h2><a href="https://www.geeksforgeeks.org/problems/power-set4302/1?page=1&sprint=c9a1cd89043a2936af29068edd324841&sortBy=submissions">Power Set</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string S, Find&nbsp;all the possible subsequences&nbsp;of the String in lexicographically-sorted order.</span></p>
